...
import type { Pattern, getLocationStats, getOverview } from "../domain/insights";
import type { HourLens, NetworkMode } from "../domain/graph";
import { neighborIdsOf } from "../domain/relationships";
...
export function neighborIds(id: string, edges?: ConnectionEdge[]): string[] {
  return neighborIdsOf(id, useLifeStore.getState().edgesByNode, edges);
}
