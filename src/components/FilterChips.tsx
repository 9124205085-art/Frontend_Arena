  ...
  return (
    <div className="no-scrollbar flex gap-2 overflow-x-auto pb-1" role="group" aria-label="Filter by category">
      <button
        ...
        aria-pressed={allOn}
        className={`min-h-11 shrink-0 rounded-full border px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.16em] transition ${
      ...
      {present.map((t) => {
        ...
        return (
          <button
            ...
            className="min-h-11 shrink-0 rounded-full border px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.14em] transition hover:brightness-125"
            style={{
